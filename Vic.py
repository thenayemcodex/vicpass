...
print(numbr[6:12])
print('Wait until it says"Password.txt file Done "')
...
for var in range(0, 10000000):
    ...
    file.close()
print('Password.txt file done')
ye = 'yes'
n = 'no'
see = input('\033[1;92m Do You want see the passwords : ')
if see == ye:
    os.system('cat password.txt')
elif see == n:
    print('Thank You For Using This Tool',u,'Sir')